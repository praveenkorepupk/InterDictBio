...
credentials <- data.frame(
  ...
  # user = c("lhamann@interdictbio.com",  "nbratset@interdictbio.com", "cswanson@interdictbio.com", 
  #          "aschuller@interdictbio.com", "lkenner@interdictbio.com", "dgygi@interdictbio.com", 
  #          "sbahmanyar@interdictbio.com", "admin@interdictbio.com", "psauer@interdictbio.com",
  #          "pdiamond@interdictbio.com", "lferguson@interdictbio.com"), # mandatory
  # 
  # password = c("lh@123", "nb@123","cs@123", 
  #              "as@123", "lk@123","dg@123",
  #              "sb@123", "admin@123", "ps@123", 
  #              "pd@123", "lf@123"), # mandatory
  # 
  
  user = c("lhamann", "sbahmanyar", "pdiamond",
           "psauer", "lferguson", "nbratset", 
           "hadams", "aschuller", "mholm", 
           "mmeyers", "gwienker", "zkonst", "cswanson"),
  
  # email = c("lhamann@interdictbio.com", "sbahmanyar@interdictbio.com", "pdiamond@interdictbio.com",
  #           "psauer@interdictbio.com", "lferguson@interdictbio.com", "nbratset@interdictbio.com", 
  #           "hadams@interdictbio.com", "aschuller@interdictbio.com", "mholm@interdictbio.com",
  #           "mmeyers@interdictbio.com", "gwienker@interdictbio.com", "zkonst@interdictbio.com", "cswanson@interdictbio.com"),
  
  password = c("lhamann@123", "sbahmanyar@123", "pdiamond@123",
               "psauer@123", "lferguson@123", "nbratset@123", 
               "hadams@123", "aschuller@123", "mholm@123",
               "mmeyers@123", "gwienker@123", "zkonst@123", "cswanson@123"),
  
  
  start = c("2015-04-15"), # optional (all others)
  expire = c("2032-12-31"),
  ...
  moreInfo = c("someData1", "someData2","someData3",
               "someData4","someData5","someData6",
               "someData7","someData8","someData9",
               "someData10","someData11", "someData12", "someData13"),
...
ui <- secure_app(head_auth = tags$script(inactivity),
                 ...
                 background  = "url('blur_image_05_4_3_2_1.jpg');",
                 fab_position = "none",
                 # fab_button = "none",
                 ...
                 dashboardPage(
                   dashboardHeader(
                     title = tags$div(
                       ...
                       tags$img(height = "25px", src = "output-onlinepngtools.png"),
                     ),
                     tags$li(class = "dropdown", style = "float: left; ",
                             tags$a(href = "https://www.interdictbio.com/",
                                    "Research and Development of Pharmaceuticals",
                                    style = 'font-size:125%;font-weight: bold; color: black;margin-right: 800px;'),
                     ),
                     tags$li(
                       class = "dropdown",
                       actionLink("blank", HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"))  # Add blank text as a placeholder
                     ),
                     tags$li(class = "dropdown",
                             actionLink("User", "User", icon = icon("user", lib = "glyphicon"),
                                        style = 'font-size:125%;font-weight: bold; margin-left:-16px;')
                     ),
                     tags$li(class = "dropdown",
                             actionLink("action_logout", "Exit", icon = icon("off", lib = "glyphicon"),
                                        style = 'font-size:125%;font-weight: bold; margin-left:-160px;')
                     )
                   ),
                   dashboardSidebar(
    ...
    .tabbable > .nav > li > a[data-value='Upload data'] {background-color: #847c8a; color:white; font-size: 16px;}
  ...
  ")),
                     tabsetPanel(id = 'dataset',
                                 ...
                                 tabPanel("Upload data",icon = icon("table"),
                                          ...
                                          shinycssloaders::withSpinner(dataTableOutput("sixmerDisplay"))),
                                 tabPanel("Static 6-mer data",icon = icon("table"),
                                          dashboardSidebar(width = 250,
                                                           br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
                                                           br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
                                                           uiOutput("ExcelraUrl7")),
...
server <- function(input, output, session) {
  ...
  #     # Check if user matches either the 'user' or 'email' column
  #     user_info <- credentials[credentials$user == user | credentials$email == user, ]
  #     
  #     # If user_info is found and password matches
  #     if (nrow(user_info) == 1 && user_info$password == password) {
  #       return(list(result = TRUE, user = user_info$user, level = user_info$level))
  #     } else {
  ...
  selectedDf <- eventReactive(input$refreshDb,{
    ...
    if(rbindcounter()>0){
      ...
      dfsel
    }else if(dim(exdf)[1] == 0){
      print("it is empty please select the rows from tab 1")
    }else{
      print("no rbind")
